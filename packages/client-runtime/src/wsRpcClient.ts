...
export interface WsRpcClient {
  ...
  readonly vcs: {
    ...
    readonly restoreFiles: RpcUnaryMethod<typeof WS_METHODS.vcsRestoreFiles>;
  };
  readonly git: {
  ...
  readonly server: {
    ...
    readonly getProviderRuntimeStatus: RpcUnaryMethod<
      typeof WS_METHODS.serverGetProviderRuntimeStatus
    >;
    /**
...
export function createWsRpcClient(
  ...
  return {
    ...
    vcs: {
      ...
      restoreFiles: (input) =>
        transport.request((client) => client[WS_METHODS.vcsRestoreFiles](input)),
    },
    git: {
    ...
    server: {
      ...
      getProviderRuntimeStatus: (input) =>
        transport.request((client) => client[WS_METHODS.serverGetProviderRuntimeStatus](input)),
