...
const createDesktopBridgeStub = (overrides?: {
  ...
  return {
    ...
    setWslBackendEnabled: vi.fn().mockImplementation(async (enabled: boolean) => ({
      enabled,
      distro: null,
      available: false,
      wslOnly: false,
    ...
    setWslDistro: vi.fn().mockImplementation(async (distro: string | null) => ({
      enabled: false,
      distro,
      available: false,
      wslOnly: false,
    ...
    setWslOnly: vi.fn().mockImplementation(async (enabled: boolean) => ({
      enabled: false,
      distro: null,
      available: false,
      wslOnly: enabled,
