...
function buildMacLauncher(electronBinaryPath) {
  ...
  // Preserve Electron's relative framework symlinks so the copied app bundle
  // remains self-contained on macOS. Node's default copy behavior can rewrite
  // them into absolute links back into node_modules.
